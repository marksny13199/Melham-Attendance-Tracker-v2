<?php
	...
	$sql2 = "SELECT * FROM team_members, user_acc where team_members.user_acc_id=user_acc.user_acc_id AND team_members.team_name_id='$team_id' ORDER by user_acc.last_login DESC";
